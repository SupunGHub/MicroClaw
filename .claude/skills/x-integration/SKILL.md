---
name: x-integration
description: X (Twitter) integration for MicroClaw. Post tweets, like, reply, retweet, and quote. Use for setup, testing, or troubleshooting X functionality. Triggers on "setup x", "x integration", "twitter", "post tweet", "tweet".
---
...
> **Compatibility:** MicroClaw v1.0.0. Directory structure may change in future versions.
...
1. **MicroClaw is installed and running** - WhatsApp connected, service active
...
To integrate this skill into MicroClaw, make the following modifications:
